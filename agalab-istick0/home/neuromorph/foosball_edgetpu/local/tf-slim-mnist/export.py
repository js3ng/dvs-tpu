...
if __name__ == '__main__':
  ...
  with tf.Graph().as_default() as graph:
    with tf.Session(graph=graph) as sess:
      ...
      input_shape = [FLAGS.batch_size, image_size, image_size, channels]
      ...
      images_, label = test_data
      print('Inputs: ', images, 'Outputs:', pred)
      
      print (pred.eval(session=sess, feed_dict={images:np.expand_dims(images_[:100],3)}))
    ...
    freeze_graph.freeze_graph(
      	...
      	output_node_names="fully_connected5/BiasAdd",
      	initializer_nodes='',
      	input_binary=False,
      	input_saver=False,
      	input_checkpoint='./logs/model.ckpt-1000',
